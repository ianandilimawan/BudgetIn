    ...
    <div class="space-y-6">
        ...
        <div class="flex items-center gap-4 mb-6">
            ...
            <div>
                ...
                <h1 class="lg:text-2xl text-xl font-semibold text-gray-900 dark:text-white">Create New Transaction Category</h1>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-gray-900 rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100/50 dark:border-gray-800 overflow-hidden">
            <form x-data="ajaxForm" @submit.prevent="submit" action="{{ route('admin.transaction_categories.store') }}" method="POST" enctype="multipart/form-data" class="lg:p-8 px-4 py-4 space-y-6 overflow-x-hidden">
                @csrf

@include('admin.transaction_categories.fields')
                ...
                <div class="flex items-center justify-end gap-4 pt-8 border-t border-gray-100 dark:border-gray-800 mt-8">
                    ...
                    <button type="submit" x-bind:disabled="loading"
                        ...
                        <span x-show="!loading">Create Transaction Category</span>
                        <span x-show="loading" style="display: none;">
                            <svg class="animate-spin -ml-1 mr-3 h-5 w-5 text-white inline" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
