...
<div class="space-y-4 sm:space-y-6">
    ...
    <div class="flex items-center gap-3 sm:gap-4">
        ...
        <div>
            ...
            <h1 class="text-base sm:text-lg lg:text-xl font-bold text-zinc-900 dark:text-white">Tambah Transaksi Baru</h1>
        </div>
    </div>
    ...
    <div class="bg-white/80 dark:bg-zinc-900/80 backdrop-blur-xl rounded-2xl shadow-xs border border-zinc-200/60 dark:border-zinc-800/60 overflow-hidden">
        <form x-data="ajaxForm" @submit.prevent="submit" action="{{ route('admin.cash_transactions.store') }}" method="POST" enctype="multipart/form-data" class="p-4 sm:p-6 lg:p-8 space-y-4 sm:space-y-6 overflow-x-hidden">
            @csrf
