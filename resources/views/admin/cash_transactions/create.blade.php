...
@section('content')
    <div class="space-y-6">
        ...
        <div class="flex items-center gap-4 mb-6">
            <a href="{{ route('admin.cash_transactions.index') }}" class="p-2 bg-white dark:bg-gray-800 rounded-full shadow-sm border border-gray-100 dark:border-gray-700 text-gray-500 hover:text-indigo-600 hover:bg-gray-50 transition-all duration-200">
            ...
            <div>
                <nav class="flex text-sm text-gray-500 font-medium mb-1" aria-label="Breadcrumb">
                    <ol class="inline-flex items-center space-x-1 md:space-x-2">
                        <li class="inline-flex items-center">
                            <a href="{{ route('admin.cash_transactions.index') }}" class="hover:text-indigo-600 transition-colors">Cash Transactions</a>
                        </li>
                        <li>
                ...
                <h1 class="lg:text-2xl text-xl font-semibold text-gray-900 dark:text-white">Create New Cash Transaction</h1>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-gray-900 rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100/50 dark:border-gray-800 overflow-hidden">
            <form x-data="ajaxForm" @submit.prevent="submit" action="{{ route('admin.cash_transactions.store') }}" method="POST" enctype="multipart/form-data" class="lg:p-8 px-4 py-4 space-y-6 overflow-x-hidden">
                @csrf
...
@include('admin.cash_transactions.fields')
                ...
                <div class="flex items-center justify-end gap-4 pt-8 border-t border-gray-100 dark:border-gray-800 mt-8">
                    ...
                    <button type="submit" x-bind:disabled="loading"
                        ...
                        <span x-show="!loading">Create Cash Transaction</span>
