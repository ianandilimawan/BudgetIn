<div x-data="{
    ...
    <!-- Name of schedule -->
    <div>
        <label for="name" class="block text-[11px] sm:text-xs uppercase tracking-wider font-medium text-gray-700 dark:text-gray-300 mb-1">
    ...
    <div>
        <label class="block text-[11px] sm:text-xs uppercase tracking-wider font-medium text-zinc-700 dark:text-zinc-300 mb-1">
    ...
    <div x-show="trxType !== 'transfer'">
        <div x-show="trxType === 'expense'">
            ...
            <select name="category_id" class="w-full h-[40px] sm:h-[42px] px-3 sm:px-3.5 py-1.5 sm:py-2 rounded-xl border border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-800 text-zinc-900 dark:text-white text-xs sm:text-sm font-normal focus:outline-none focus:ring-2 focus:ring-rose-500/20 focus:border-rose-500" :disabled="trxType !== 'expense'">
        ...
        <div x-show="trxType === 'income'" style="display: none;">
            ...
            <select name="category_id" class="w-full h-[40px] sm:h-[42px] px-3 sm:px-3.5 py-1.5 sm:py-2 rounded-xl border border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-800 text-zinc-900 dark:text-white text-xs sm:text-sm font-normal focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500" :disabled="trxType !== 'income'">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
        <div>
            <label class="block text-[11px] sm:text-xs uppercase tracking-wider font-medium text-zinc-700 dark:text-zinc-300 mb-1" x-text="trxType === 'transfer' ? 'Dari Akun Asal *' : (trxType === 'expense' ? 'Dari Dompet / Bank *' : 'Masuk Ke Dompet / Bank *')">
                Akun / Dompet
            </label>
            <select name="account_id" class="w-full h-[40px] sm:h-[42px] px-3 sm:px-3.5 py-1.5 sm:py-2 rounded-xl border border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-800 text-zinc-900 dark:text-white text-xs sm:text-sm font-normal focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500" required>
        ...
        <div x-show="trxType === 'transfer'" style="display: none;">
            ...
            <select name="to_account_id" class="w-full h-[40px] sm:h-[42px] px-3 sm:px-3.5 py-1.5 sm:py-2 rounded-xl border border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-800 text-zinc-900 dark:text-white text-xs sm:text-sm font-normal focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500" :disabled="trxType !== 'transfer'">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 border border-zinc-200/80 dark:border-zinc-800 rounded-xl sm:rounded-2xl p-3 sm:p-4 bg-zinc-50/50 dark:bg-zinc-800/30">
        <div>
            ...
            <select name="frequency" x-model="freq" class="w-full h-[40px] sm:h-[42px] px-3 sm:px-3.5 py-1.5 sm:py-2 rounded-xl border border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-800 text-zinc-900 dark:text-white text-xs sm:text-sm font-normal focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 cursor-pointer">
        ...
        <div x-show="freq === 'monthly'">
            ...
            <select name="day_of_month" class="w-full h-[40px] sm:h-[42px] px-3 sm:px-3.5 py-1.5 sm:py-2 rounded-xl border border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-800 text-zinc-900 dark:text-white text-xs sm:text-sm font-normal focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 cursor-pointer">
                @for ($d = 1; $d <= 31; $d++)
    ...
    <!-- Catatan -->
    <div>
        <label for="recurring_note" class="block text-[11px] sm:text-xs uppercase tracking-wider font-medium text-gray-700 dark:text-gray-300 mb-1">
