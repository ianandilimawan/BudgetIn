<div x-data="{
    ...
    <div x-show="trxType !== 'transfer'">
        <div x-show="trxType === 'expense'">
            ...
            <select name="category_id" class="w-full h-[46px] px-3.5 py-2.5 rounded-xl border border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-800 text-zinc-900 dark:text-white text-sm font-medium focus:outline-none focus:ring-2 focus:ring-rose-500/20 focus:border-rose-500" :disabled="trxType !== 'expense'">
        ...
        <div x-show="trxType === 'income'" style="display: none;">
            ...
            <select name="category_id" class="w-full h-[46px] px-3.5 py-2.5 rounded-xl border border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-800 text-zinc-900 dark:text-white text-sm font-medium focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500" :disabled="trxType !== 'income'">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div>
            <label class="block text-xs uppercase tracking-wider font-bold text-zinc-700 dark:text-zinc-300 mb-1.5" x-text="trxType === 'transfer' ? 'Dari Akun / Dompet Asal *' : (trxType === 'expense' ? 'Dari Dompet / Bank *' : 'Masuk Ke Dompet / Bank *')">
                Akun / Dompet
            </label>
            <select name="account_id" class="w-full h-[46px] px-3.5 py-2.5 rounded-xl border border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-800 text-zinc-900 dark:text-white text-sm font-medium focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500" required>
        ...
        <div x-show="trxType === 'transfer'" style="display: none;">
            <label class="block text-xs uppercase tracking-wider font-bold text-emerald-600 dark:text-emerald-400 mb-1.5">
                Ke Dompet Tujuan <span class="text-emerald-500">*</span>
            </label>
            <select name="to_account_id" class="w-full h-[46px] px-3.5 py-2.5 rounded-xl border border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-800 text-zinc-900 dark:text-white text-sm font-medium focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500" :disabled="trxType !== 'transfer'">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 border border-zinc-200 dark:border-zinc-700/80 rounded-2xl p-5 bg-zinc-50/50 dark:bg-zinc-800/30">
        <div>
            ...
            <select name="frequency" x-model="freq" class="w-full h-[46px] px-3.5 py-2.5 rounded-xl border border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-800 text-zinc-900 dark:text-white text-sm font-medium focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500">
        ...
        <div x-show="freq === 'monthly'">
            ...
            <select name="day_of_month" class="w-full h-[46px] px-3.5 py-2.5 rounded-xl border border-zinc-200 dark:border-zinc-700 bg-white dark:bg-zinc-800 text-zinc-900 dark:text-white text-sm font-medium focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500">
                @for ($d = 1; $d <= 31; $d++)
