...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-bold tracking-tight text-zinc-900 dark:text-white">Tambah Jadwal Transaksi Berulang</h1>
            <p class="text-sm text-zinc-500 dark:text-zinc-400 mt-1">Buat jadwal otomatis untuk mencatat pengeluaran atau pemasukan rutin secara otomatis.</p>
        </div>
