                            ...
                            <template x-for="item in typeList" :key="item.id">
                                <div class="flex items-center justify-between p-2.5 bg-white dark:bg-zinc-800/80 border border-zinc-200/80 dark:border-zinc-700/80 rounded-xl hover:border-zinc-300 dark:hover:border-zinc-600 transition-colors shadow-2xs">
                                    <div class="flex items-center gap-2.5 min-w-0">
                                        ...
                                        <div class="min-w-0">
                                            <div class="text-xs font-bold text-zinc-900 dark:text-white truncate" x-text="item.name"></div>
                                    ...
                                    <div class="flex items-center gap-1 flex-shrink-0">
                                        <button type="button" @click="editType(item)" class="p-1.5 text-zinc-400 hover:text-indigo-600 dark:hover:text-indigo-400 hover:bg-zinc-100 dark:hover:bg-zinc-700 rounded-lg transition-colors cursor-pointer" title="Edit">
                                            <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path></svg>
                                        </button>
                                        <button type="button" @click="deleteType(item)" class="p-1.5 text-zinc-400 hover:text-rose-600 dark:hover:text-rose-400 hover:bg-rose-50 dark:hover:bg-rose-950/40 rounded-lg transition-colors cursor-pointer" title="Hapus">
