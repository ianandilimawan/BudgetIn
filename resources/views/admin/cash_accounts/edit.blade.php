...
<div class="space-y-4 sm:space-y-6">
    ...
    <div class="flex items-center gap-3 sm:gap-4">
        <a href="{{ route('admin.cash_accounts.index') }}"
            class="p-1.5 sm:p-2 bg-white dark:bg-zinc-800 rounded-xl shadow-xs border border-zinc-200 dark:border-zinc-700 text-zinc-500 hover:text-indigo-600 hover:bg-zinc-50 dark:hover:bg-zinc-700 transition">
        ...
        <div>
                ...
                <ol class="inline-flex items-center space-x-1">
                    ...
                    <li>
                        <div class="flex items-center">
                            <svg class="w-3 h-3 text-zinc-400 mx-1" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24">
            ...
            <h1 class="text-base sm:text-lg lg:text-xl font-bold text-zinc-900 dark:text-white">Edit Akun / Dompet</h1>
        </div>
    </div>

    <!-- Form Container -->
    <div
        class="bg-white/80 dark:bg-zinc-900/80 backdrop-blur-xl rounded-2xl shadow-xs border border-zinc-200/60 dark:border-zinc-800/60 overflow-hidden">
