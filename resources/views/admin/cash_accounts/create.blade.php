...
<div class="space-y-6">
    ...
    <div class="flex items-center gap-4">
        ...
        <div>
            ...
            <h1 class="text-xl lg:text-2xl font-bold text-zinc-900 dark:text-white">Tambah Akun / Dompet Baru</h1>
        </div>
    </div>
    ...
    <div class="bg-white/80 dark:bg-zinc-900/80 backdrop-blur-xl rounded-2xl shadow-sm border border-zinc-200/60 dark:border-zinc-800/60 overflow-hidden">
        <form x-data="ajaxForm" @submit.prevent="submit" action="{{ route('admin.cash_accounts.store') }}" method="POST" class="p-5 sm:p-8 space-y-6">
            @csrf
