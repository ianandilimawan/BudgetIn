                ...
                <template x-for="opt in typeList" :key="opt.code">
                    <button type="button"
                        ...
                        <div class="w-5 h-5 sm:w-6 sm:h-6 rounded-lg flex items-center justify-center text-[10px] sm:text-xs font-bold flex-shrink-0"
                            ...
                            <template x-if="opt.code === 'bank'">
                                <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"></path></svg>
                            </template>
                            <template x-if="opt.code === 'ewallet'">
                            ...
                            <template x-if="opt.code === 'investment'">
                            ...
                            <template x-if="opt.code !== 'cash' && opt.code !== 'bank' && opt.code !== 'ewallet' && opt.code !== 'investment' && opt.code !== 'loan'">
