<footer
    class="mt-auto py-3 px-4 pb-[max(0.75rem,env(safe-area-inset-bottom,0px))] border-t border-zinc-200/80 dark:border-zinc-800/80 bg-white/80 dark:bg-zinc-900/80 backdrop-blur-md">
